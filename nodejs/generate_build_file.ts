 ...
 */
export function generatePackageBuildFiles(pkg: Dep) {
    console.log("generating build files for", pkg._dir)
 ...
 */
export function generateBazelWorkspaces(pkgs: Dep[]) {
